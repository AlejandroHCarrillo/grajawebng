...
enum EstatusAsociados {
  en_proceso_de_validacion_de_informacion = 0, 
  rechazada_validacion_de_información = 2, 
  en_proceso_de_afiliacion = 3,
  en_espera_de_documentacion = 4, 
  activo = 1, 
  inactivo = -1
}